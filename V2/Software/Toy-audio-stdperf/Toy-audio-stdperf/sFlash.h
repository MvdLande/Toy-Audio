...
/**
  ...
  */
#define sFLASH_CS_LOW()			GPIO_WriteBit(GPIOF, GPIO_Pin_0, Bit_RESET)
/**
  * @brief  Deselect sFLASH: Chip Select pin high
  */
#define sFLASH_CS_HIGH()		GPIO_WriteBit(GPIOF, GPIO_Pin_0, Bit_SET)
/**
  * @}
  */ 
  
#define sFLASH_CLK_LOW()       	GPIO_ResetBits(GPIOA, GPIO_Pin_5)
#define sFLASH_CLK_HIGH()       GPIO_SetBits(GPIOA, GPIO_Pin_5)
#define sFLASH_MOSI_LOW()       GPIO_ResetBits(GPIOA, GPIO_Pin_7)
#define sFLASH_MOSI_HIGH()      GPIO_SetBits(GPIOA, GPIO_Pin_7)
#define sFLASH_MISO_READ()		GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_6)
